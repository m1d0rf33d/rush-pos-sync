...
var ScreenRestrictionsService = (function () {
    ...
    ScreenRestrictionsService.prototype.getScreens = function (merchantId) {
        ...
        return this.http.get(AppConfig_1.AppConfig.GET_SCREENS.replace(':merchantId', merchantId), options).map(function (res) { return res.json(); });
    };
    ScreenRestrictionsService.prototype.updateAccess = function (roleDTO) {
        ...
        headers.append('Authorization', 'Bearer ' + window.localStorage.getItem('auth_key'));
        var options = new http_1.RequestOptions({ headers: headers });
        return this.http.post(AppConfig_1.AppConfig.UPDATE_ACCESS_URL, body, options).map(function (res) { return res.json(); });
    };
    ScreenRestrictionsService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http])
    ], ScreenRestrictionsService);
    return ScreenRestrictionsService;
}());
exports.ScreenRestrictionsService = ScreenRestrictionsService;
//# sourceMappingURL=screenrestrictions.service.js.map