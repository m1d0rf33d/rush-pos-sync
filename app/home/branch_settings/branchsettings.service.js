...
var BranchService = (function () {
    ...
    BranchService.prototype.getBranches = function (merchantId) {
        ...
        return this.http.get(AppConfig_1.AppConfig.GET_BRANCHES_URL.replace(':merchantId', merchantId), options).map(function (res) { return res.json(); });
    };
    BranchService.prototype.updateBranch = function (branchDTO) {
        ...
        headers.append('Authorization', 'Bearer ' + window.localStorage.getItem('auth_key'));
        var options = new http_1.RequestOptions({ headers: headers });
        return this.http.post(AppConfig_1.AppConfig.UPDATE_BRANCH_URL, body, options).map(function (res) { return res.json(); });
    };
...
//# sourceMappingURL=branchsettings.service.js.map